...
HD_PWD='H:/Semester 7/CA/Lab/Lab2/uart-github/verilog-uart-working/for_fpga/check_project/check_display_of_fpga/check_display_of_fpga.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log check_display_of_fpga.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source check_display_of_fpga.tcl
