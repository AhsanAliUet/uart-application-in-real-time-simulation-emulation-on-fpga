...
HD_PWD='H:/Semester 7/CA/Lab/Lab2/uart-github/verilog-uart-working/for_fpga/check_project/check_display_of_fpga/check_display_of_fpga.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log check_display_of_fpga.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source check_display_of_fpga.tcl -notrace
